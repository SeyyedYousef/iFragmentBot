...
export const fragmentLimiter = new Bottleneck({
	maxConcurrent: 2, // Max 2 concurrent browser tabs (matches pool size)
	minTime: 1000, // Min 1s between scrapes (more conservative)
	reservoir: 30, // 30 scrapes per minute max
