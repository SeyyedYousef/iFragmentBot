            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        ...
                        { text: '📢 جوین کانال/گروه (Join)', callback_data: 'fake_member_channel_join' }
                    ],
...
\`https://t.me/+abcdefg\`
        `.trim(), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: '❌ لغو', callback_data: 'fake_member' }]
                ]
            }
        });
    });
...
سپس تعداد بازدید مورد نظر را وارد کنید.
        `.trim(), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: '❌ لغو', callback_data: 'panel_fake' }]
                ]
            }
        });
    });
    ...
    bot.action('fake_comment_preset', async (ctx) => {
        ...
        await ctx.editMessageText(msg, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        { text: '👍 استفاده از مثبت', callback_data: 'use_positive_comments' },
                        { text: '😐 استفاده از خنثی', callback_data: 'use_neutral_comments' }
                    ],
