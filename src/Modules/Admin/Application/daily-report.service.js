...
import { getGiftStats, get888Stats } from '../../Market/Application/market.service.js';
...
export async function generateMarketPulse() {
    ...
    const promptData = {
        ...
        giftTrends: Object.entries(giftStats).map(([k, v]) => `${v.name}: ${v.price}`).join(', ')
    };
