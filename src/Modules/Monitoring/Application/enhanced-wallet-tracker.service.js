...
function identifyType(collectionAddress) {
    ...
    if (collectionAddress.includes('EQCA14o1') ||
    ...
    if (collectionAddress.includes('EQAOQdwd') ||
...
function formatReport(address, balance, stats, nfts) {
...
export function updateFloorPrices(usernameFloor, numberFloor) {
    ...
    console.log(`✅ Floor prices updated: Username=${FLOOR_PRICES.username}, Number=${FLOOR_PRICES.number}`);
}
